...
public class VRFK : MonoBehaviour
{
    ...
    public Vector3 armRotOffsetL;
    public Vector3 armRotOffsetR;
    ...
    void FollowRootToHead()
    {
        ...
        RotateJointToTarget(armJointL, armTargetL, armRotOffsetL);
        RotateJointToTarget(armJointR, armTargetR, armRotOffsetR);
